...
const dashboard = fs.readFileSync(__dirname + "/src/public/admin/dashboard.html", "utf-8");
const profile = fs.readFileSync(__dirname + "/src/public/profile/profile.html", "utf-8");
const employees = fs.readFileSync(__dirname + "/src/public/employees/employees.html", "utf-8");
